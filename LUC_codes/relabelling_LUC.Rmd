...
st_write(PowReduParc2012, paste0(fileDir, "PowReduTaxParcels2012.shp"))
st_write(PowReduParc2013, paste0(fileDir, "PowReduTaxParcels2013.shp"))
st_write(PowReduParc2014, paste0(fileDir, "PowReduTaxParcels2014.shp"))
st_write(PowReduParc2015, paste0(fileDir, "PowReduTaxParcels2015.shp"))
st_write(PowReduParc2016, paste0(fileDir, "PowReduTaxParcels2016.shp"))
st_write(PowReduParc2017, paste0(fileDir, "PowReduTaxParcels2017.shp"))
st_write(PowReduParc2018, paste0(fileDir, "PowReduTaxParcels2018.shp"))
st_write(PowReduParc2019, paste0(fileDir, "PowReduTaxParcels2019.shp"))
st_write(PowReduParc2020, paste0(fileDir, "PowReduTaxParcels2020.shp"))
st_write(PowReduParc2021, paste0(fileDir, "PowReduTaxParcels2021.shp"))
```
