...
ggplot(income, aes(x = variable, y = estimate, fill = variable))+ geom_bar(stat = "identity") + theme(legend.position = "none") + scale_fill_viridis(discrete=TRUE) + labs(title="Median Income by Census Tract", caption="Source: ACS5 2016-2020") + coord_flip()
```
