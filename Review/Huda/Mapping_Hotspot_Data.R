...
gl_hs_19 <- st_read(  "data/gooch_hotspot_19.shp")
gl_hs_20 <- st_read(  "data/gooch_hotspot_20.shp")
gl_hs_21 <- st_read(  "data/gooch_hotspot_21.shp")
gl_hs_22 <- st_read(  "data/gooch_hotspot_22.shp")
